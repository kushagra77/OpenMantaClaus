...
EKFSLAMParams load_ekfslam_params(rclcpp::Node & node, int feature_count)
{
  ...
  node.declare_parameter("features.flag_y", params.flag_y);
  node.declare_parameter("features.gate_left_y", params.gate_left_y);
  node.declare_parameter("features.gate_right_y", params.gate_right_y);
  node.declare_parameter("features.qual_gate_left_y", params.qual_gate_left_y);
  node.declare_parameter("features.qual_gate_right_y", params.qual_gate_right_y);
  node.declare_parameter("features.bucket1_y", params.bucket1_y);
  node.declare_parameter("features.bucket2_y", params.bucket2_y);
  node.declare_parameter("features.bucket3_y", params.bucket3_y);
  node.declare_parameter("features.bucket4_y", params.bucket4_y);
  node.declare_parameter("features.aruco_marker_x", params.aruco_marker_x);
  node.declare_parameter("features.aruco_marker_y", params.aruco_marker_y);
  node.declare_parameter("initial_pose.x", params.initial_pose_x);
  node.declare_parameter("initial_pose.y", params.initial_pose_y);
  node.declare_parameter("initial_pose.yaw_deg", params.initial_pose_yaw_deg);
  ...
  params.flag_y = node.get_parameter("features.flag_y").as_double();
  params.gate_left_y = node.get_parameter("features.gate_left_y").as_double();
  params.gate_right_y = node.get_parameter("features.gate_right_y").as_double();
  params.qual_gate_left_y = node.get_parameter("features.qual_gate_left_y").as_double();
  params.qual_gate_right_y = node.get_parameter("features.qual_gate_right_y").as_double();
  params.bucket1_y = node.get_parameter("features.bucket1_y").as_double();
  params.bucket2_y = node.get_parameter("features.bucket2_y").as_double();
  params.bucket3_y = node.get_parameter("features.bucket3_y").as_double();
  params.bucket4_y = node.get_parameter("features.bucket4_y").as_double();
  params.aruco_marker_x = node.get_parameter("features.aruco_marker_x").as_double();
  params.aruco_marker_y = node.get_parameter("features.aruco_marker_y").as_double();
  params.initial_pose_x = node.get_parameter("initial_pose.x").as_double();
  params.initial_pose_y = node.get_parameter("initial_pose.y").as_double();
  params.initial_pose_yaw_deg = node.get_parameter("initial_pose.yaw_deg").as_double();
