...
bool interfaces__msg__task_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._task_status.TaskStatus", full_classname_dest, 38) == 0);
  }
  interfaces__msg__TaskStatus * ros_message = _ros_message;
  {  // state
...
PyObject * interfaces__msg__task_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._task_status");
