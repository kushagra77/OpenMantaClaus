...
class TaskComplete_Request(metaclass=Metaclass_TaskComplete_Request):
    ...
    def __init__(self, **kwargs):
        ...
        self.task_completed = kwargs.get('task_completed', bool())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.task_completed != other.task_completed:
            return False
        return True
    ...
    def task_completed(self):
        """Message field 'task_completed'."""
        return self._task_completed

    @task_completed.setter
    def task_completed(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'task_completed' field must be of type 'bool'"
...
class Metaclass_TaskComplete(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from interfaces.srv import _task_complete
...
class TaskComplete(metaclass=Metaclass_TaskComplete):
    from interfaces.srv._task_complete import TaskComplete_Request as Request
    from interfaces.srv._task_complete import TaskComplete_Response as Response
