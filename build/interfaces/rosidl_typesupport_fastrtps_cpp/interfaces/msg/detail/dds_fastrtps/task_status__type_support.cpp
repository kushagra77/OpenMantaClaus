...
#include "interfaces/msg/detail/task_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::TaskStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::TaskStatus & ros_message)
{
  // Member: state
  cdr >> ros_message.state;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::msg::TaskStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::msg::TaskStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::TaskStatus *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_TaskStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, TaskStatus)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_TaskStatus__handle;
}
